...
public:
	...
	FText GetNameText() const { return InteractionNameText; }

	UFUNCTION(BlueprintCallable, BlueprintPure, Category="Gameplay")
	FText GetUseText() const { return InteractionUseText; }

	double GetInteractionDistance() const { return InteractionDistance; }
